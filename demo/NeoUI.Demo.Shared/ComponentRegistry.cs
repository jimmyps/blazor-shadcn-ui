...
public static class ComponentRegistry
{
    ...
    private static List<ComponentRegistryEntry> BuildAll()
    {
        ...
        var components = new List<ComponentRegistryEntry>
        {
            ...
            new("filter/nested",    "Nested Groups",    "Complex AND/OR logic with nested condition groups",                                  "filter",                C, AI, IsSubPage: true),
            new("filter/persistence","State Persistence","Save and restore filter state with localStorage",                                   "filter",                C, AI, IsSubPage: true),
