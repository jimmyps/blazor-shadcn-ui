...
public static class ComponentRegistry
{
    ...
    private static List<ComponentRegistryEntry> BuildAll()
    {
        ...
        var components = new List<ComponentRegistryEntry>
        {
            ...
            new("datagrid/blazor-server-side",  "Blazor Server-Side",   "License-free server-side paging/sorting/filtering with a single JS↔C# interop round trip", "zap", C, DD, IsSubPage: true),
