...
/// <summary>
/// Multi-series line chart component for visualizing multiple data series.
/// </summary>
/// <typeparam name="TData">The type of data items in the chart.</typeparam>
public class MultiSeriesLineChartBase<TData> : ComponentBase
{
    ...
    /// </summary>
    [Parameter, EditorRequired]
    public IEnumerable<ChartSeriesConfig> Series { get; set; } = Enumerable.Empty<ChartSeriesConfig>();
