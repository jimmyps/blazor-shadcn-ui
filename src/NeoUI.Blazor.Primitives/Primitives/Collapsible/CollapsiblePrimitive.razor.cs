...
/// <remarks>
/// <para>
/// The CollapsiblePrimitive component is a headless (unstyled) component that handles all the behavior,
...
/// <list type="bullet">
/// <item><see cref="CollapsiblePrimitive"/> - Container that manages state and provides context</item>
/// <item><see cref="CollapsibleTriggerPrimitive"/> - Button that toggles the open/closed state</item>
/// <item><see cref="CollapsibleContentPrimitive"/> - Content area that expands/collapses</item>
/// </list>
/// </para>
/// <para>
...
/// <code>
/// &lt;CollapsiblePrimitive @bind-Open="isOpen"&gt;
///     &lt;CollapsibleTriggerPrimitive&gt;
...
/// </code>
/// </example>
public partial class CollapsiblePrimitive : ComponentBase
{
