...
/// <summary>
/// A headless trigger button component that toggles the open/closed state of a CollapsiblePrimitive.
/// </summary>
/// <remarks>
/// <para>
/// The CollapsibleTriggerPrimitive component is a headless primitive that handles all interaction behavior,
...
///         Toggle Content
///     &lt;/CollapsibleTriggerPrimitive&gt;
///     &lt;CollapsibleContentPrimitive&gt;...&lt;/CollapsibleContentPrimitive&gt;
/// &lt;/CollapsiblePrimitive&gt;
/// </code>
///
/// Styled trigger with custom classes:
/// <code>
/// &lt;CollapsibleTriggerPrimitive class="flex items-center gap-2 px-4 py-2 hover:bg-accent"&gt;
///     &lt;svg&gt;...&lt;/svg&gt;
///     &lt;span&gt;Show More&lt;/span&gt;
/// &lt;/CollapsibleTriggerPrimitive&gt;
/// </code>
/// </example>
public partial class CollapsibleTriggerPrimitive : ComponentBase
{
    /// <summary>
