...
/// <summary>
/// A headless content component that displays collapsible content controlled by a CollapsibleTriggerPrimitive.
/// </summary>
/// <remarks>
/// <para>
/// The CollapsibleContentPrimitive component is a headless primitive that handles content visibility
/// based on the collapsible state. It provides no default styling, only behavior and accessibility.
/// </para>
/// <para>
/// This component must be used as a child of a <see cref="CollapsiblePrimitive"/> component.
...
/// <code>
/// &lt;CollapsibleContentPrimitive class="p-4 border-t transition-all"&gt;
///     &lt;div class="space-y-2"&gt;
///         &lt;p&gt;Paragraph 1&lt;/p&gt;
///         &lt;p&gt;Paragraph 2&lt;/p&gt;
///     &lt;/div&gt;
...
/// <code>
/// &lt;CollapsibleContentPrimitive class="overflow-hidden data-[state=open]:animate-slideDown data-[state=closed]:animate-slideUp"&gt;
///     &lt;div class="p-4"&gt;
...
/// </code>
/// </example>
public partial class CollapsibleContentPrimitive : ComponentBase
{
    private bool _shouldRender => ForceMount || (Context?.Open ?? false);

    /// <summary>
    /// Gets the cascaded collapsible context from the parent CollapsiblePrimitive component.
    /// </summary>
    /// <value>
    /// A <see cref="CollapsibleContext"/> instance provided by the parent, or <c>null</c>
    /// if this component is not nested within a <see cref="CollapsiblePrimitive"/>.
    /// </value>
    [CascadingParameter]
