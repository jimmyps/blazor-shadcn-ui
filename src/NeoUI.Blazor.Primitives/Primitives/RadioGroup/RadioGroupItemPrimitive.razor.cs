...
/// <summary>
/// A headless radio button item primitive that can be selected within a RadioGroupPrimitive.
/// </summary>
/// <typeparam name="TValue">The type of the value associated with this radio item.</typeparam>
/// <remarks>
/// <para>
/// The RadioGroupItemPrimitive component represents a single selectable option within a RadioGroupPrimitive.
/// It provides no default styling, only behavior and accessibility features.
/// </para>
/// <para>
/// This component must be used as a child of a RadioGroupPrimitive component.
...
/// </code>
/// </example>
public partial class RadioGroupItemPrimitive<TValue> : ComponentBase, IDisposable
{
    private ElementReference buttonElement;
    private bool shouldPreventDefault = false;

    /// <summary>
    /// Gets or sets the parent RadioGroupPrimitive context.
    /// </summary>
    [CascadingParameter]
    ...
    /// </summary>
    /// <remarks>
    /// When this item is selected, this value becomes the RadioGroupPrimitive's Value.
    /// </remarks>
    ...
    protected override void OnInitialized()
    {
        ...
        // Register with parent RadioGroupPrimitive
    ...
    public void Dispose()
    {
        // Unregister from parent RadioGroupPrimitive
