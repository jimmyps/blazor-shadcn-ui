...
```bash
dotnet add package NeoUI.Icons.Heroicons
```
...
- **NeoUI**: [GitHub Repository](https://github.com/jimmyps/blazor-shadcn-ui)
- **Issues**: [Report a Bug](https://github.com/jimmyps/blazor-shadcn-ui/issues)
