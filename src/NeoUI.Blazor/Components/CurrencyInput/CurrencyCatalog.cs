...
{
    /// <summary>
    /// Dictionary of all supported currencies, keyed by ISO 4217 currency code.
    /// </summary>
    public static readonly IReadOnlyDictionary<string, CurrencyDefinition> Currencies = new Dictionary<string, CurrencyDefinition>
    {
        // North America
        ...
        ["CHF"] = new() { Code = "CHF", Symbol = "CHF", DecimalPlaces = 2, CultureName = "de-CH", Name = "Swiss Franc" },
        ["SEK"] = new() { Code = "SEK", Symbol = "kr", DecimalPlaces = 2, CultureName = "sv-SE", Name = "Swedish Krona" },
        ["NOK"] = new() { Code = "NOK", Symbol = "kr", DecimalPlaces = 2, CultureName = "nb-NO", Name = "Norwegian Krone" },
        ["DKK"] = new() { Code = "DKK", Symbol = "kr", DecimalPlaces = 2, CultureName = "da-DK", Name = "Danish Krone" },
        ["PLN"] = new() { Code = "PLN", Symbol = "zł", DecimalPlaces = 2, CultureName = "pl-PL", Name = "Polish Zloty" },
        ["CZK"] = new() { Code = "CZK", Symbol = "Kč", DecimalPlaces = 2, CultureName = "cs-CZ", Name = "Czech Koruna" },
        ["HUF"] = new() { Code = "HUF", Symbol = "Ft", DecimalPlaces = 0, CultureName = "hu-HU", Name = "Hungarian Forint" },
        ["RON"] = new() { Code = "RON", Symbol = "lei", DecimalPlaces = 2, CultureName = "ro-RO", Name = "Romanian Leu" },
        ["RUB"] = new() { Code = "RUB", Symbol = "₽", DecimalPlaces = 2, CultureName = "ru-RU", Name = "Russian Ruble" },
        ...
        ["PEN"] = new() { Code = "PEN", Symbol = "S/", DecimalPlaces = 2, CultureName = "es-PE", Name = "Peruvian Sol" },
    ...
    {
        return Currencies.TryGetValue(code.ToUpperInvariant(), out var currency) ? currency : Currencies["USD"];
    }
