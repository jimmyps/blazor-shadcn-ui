...
/// <summary>
/// Renders the circular icon node for a timeline item.
/// </summary>
public partial class TimelineIcon : ComponentBase
{
    ...
    /// <summary>Gets or sets the status of the timeline item.</summary>
    [Parameter]
    ...
    /// <summary>Gets or sets the visual style variant (Solid or Outline).</summary>
    [Parameter]
    public TimelineIconVariant Variant { get; set; } = TimelineIconVariant.Solid;

    /// <summary>Gets or sets whether the icon is in a loading state (pulse animation).</summary>
    [Parameter]
    ...
    /// <summary>Gets or sets custom icon content to render inside the circle.</summary>
    [Parameter]
