...
dotnet add package NeoUI.Icons.Lucide      # 1,834 icons - stroke-based, consistent
...
```razor
@using NeoUI.Icons.Lucide      @* 1,834 icons *@
...
- **Lucide Icons** (`NeoUI.Icons.Lucide`) - 1,834 beautiful, consistent stroke-based icons
  - ISC licensed
